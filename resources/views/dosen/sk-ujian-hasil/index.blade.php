{{-- resources/views/dosen/sk-ujian-hasil/index.blade.php --}}

@extends('layouts.dosen.app')

@section('title', 'SK Ujian Hasil - ' . $dosen->nama)

@section('header-title', 'SK Ujian Hasil Mahasiswa')
@section('header-subtitle', 'Daftar Surat Keputusan Ujian Hasil mahasiswa bimbingan Anda')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="fs-2 fw-bold text-danger">{{ $stats['total_file'] }}</div>
                            <div class="text-muted small">Total SK Ujian Hasil</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <button class="btn btn-danger w-100" onclick="searchMahasiswa()">
        ...
        <div class="card-header bg-white border-bottom-0 py-3">
            <div class="d-flex justify-content-between align-items-center">
                <span class="fw-semibold">
                    <i class="fas fa-list me-2 text-danger"></i>Daftar SK Ujian Hasil
                </span>
        ...
        <div class="card-body p-0">
            @if($skripsiList->isEmpty())
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mb-0">Belum ada SK Ujian Hasil yang tersedia.</p>
                    <p class="text-muted small mt-1">SK Ujian Hasil akan muncul setelah disinkronkan dari e-Service</p>
                </div>
            @else
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" id="skUjianHasilTable">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center pe-4">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('dosen.sk-ujian-hasil.download', $skripsi) }}" 
...
<script>
    function searchMahasiswa() {
        ...
        let table = document.getElementById('skUjianHasilTable');
