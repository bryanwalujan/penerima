{{-- resources/views/dosen/sk-pembimbing/index.blade.php --}}

@extends('layouts.dosen.app')

@section('title', 'SK Pembimbing Bimbingan')

@section('header-title', 'SK Pembimbing Bimbingan')
@section('header-subtitle', 'Daftar Surat Keputusan pembimbing mahasiswa bimbingan Anda')
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                ...
                SK Pembimbing Bimbingan
            </h1>
            <p class="text-gray-600 mt-1">
                Daftar Surat Keputusan pembimbing skripsi mahasiswa yang Anda bimbing
            </p>
        </div>
        <div class="bg-blue-100 rounded-lg px-4 py-2">
            <span class="text-blue-800 font-semibold">Total: {{ $stats['total_mahasiswa'] }} Mahasiswa</span>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white rounded-xl shadow-md p-5 stats-card border-l-4 border-blue-600">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-500 text-sm font-medium">Total SK Pembimbing</p>
                <p class="text-3xl font-bold text-gray-800 mt-1">{{ $stats['total_sk'] }}</p>
            </div>
            <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
...
<div class="bg-white rounded-xl shadow-lg overflow-hidden">
    <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
        <h3 class="text-lg font-semibold text-white flex items-center">
            <i class="fas fa-file-alt mr-2"></i> Daftar SK Pembimbing Mahasiswa Bimbingan
        </h3>
    </div>
    <div class="p-4 overflow-x-auto">
        @if($skripsiList->isEmpty())
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 text-lg">Belum ada SK Pembimbing yang tersedia.</p>
                <p class="text-gray-400 text-sm mt-2">SK Pembimbing akan muncul setelah diupload oleh admin.</p>
            </div>
        @else
                        ...
                        <tr class="border-b hover:bg-gray-50 table-row">
                            ...
                            <td class="py-3 px-4 text-center">
                                <div class="flex justify-center space-x-3">
                                    <button onclick="previewFile('{{ route('dosen.sk-pembimbing.preview', $skripsi) }}', '{{ $skripsi->nama_mahasiswa }}', 'sk_pembimbing')" 
                                            class="text-blue-600 hover:text-blue-800 btn-action" title="Preview">
                                        <i class="fas fa-eye text-lg"></i>
                                    </button>
                                    <a href="{{ route('dosen.sk-pembimbing.download', $skripsi) }}" 
    ...
    <div class="relative w-full max-w-6xl mx-auto mt-10 mb-10">
        <div class="bg-white rounded-xl shadow-2xl">
            ...
            <div class="flex justify-end p-4 border-t bg-gray-50 rounded-b-xl">
                ...
                <a href="#" id="downloadLink" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
...
<script>
    function previewFile(previewUrl, namaMahasiswa, type) {
        ...
        let title = 'Preview SK Pembimbing';
