{{-- resources/views/admin/file/sk-proposal/index.blade.php --}}

@extends('layouts.admin.app')

@section('title', 'SK Proposal - Repositori Dosen')

@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-800 flex items-center">
        <i class="fas fa-file-alt text-blue-600 mr-2"></i>SK Proposal Mahasiswa
    </h1>
    <p class="text-gray-600 mt-1">Daftar Surat Keputusan (SK) Proposal skripsi mahasiswa</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-gray-600">Total SK Proposal</p>
                <p class="text-2xl font-semibold text-gray-900">{{ $stats['total_sk_proposal'] }}</p>
            </div>
        </div>
    </div>
    <div class="bg-white rounded-lg shadow p-6">
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="p-4 border-b">
        <h3 class="text-lg font-semibold text-gray-800">
            <i class="fas fa-list text-blue-600 mr-2"></i> Daftar SK Proposal
        </h3>
    </div>
    <div class="p-4 overflow-x-auto">
        <table class="w-full min-w-max" id="skProposalTable">
            <thead>
                ...
                @foreach($dosens as $dosen)
                    @foreach($dosen->skripsiSebagaiPembimbing1 as $skripsi)
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4">
                                <a href="{{ route('admin.file.sk-proposal.dosen', $dosen) }}" class="text-blue-600 hover:underline">
                                    {{ $dosen->nama }}
                                </a>
                            </td>
        ...
        @if($no == 1)
            <div class="text-center py-8">
                ...
                <p class="text-gray-500">Belum ada SK Proposal yang tersedia.</p>
                <p class="text-sm text-gray-400 mt-1">SK Proposal akan muncul setelah disinkronkan dari e-Service</p>
            </div>
        @endif
    </div>
</div>
        ...
        <div class="bg-white rounded-lg shadow-lg">
            <div class="flex justify-between items-center p-4 border-b">
                <h3 class="text-lg font-semibold" id="modalTitle">
                    <i class="fas fa-file-alt text-blue-600 mr-2"></i>Preview SK Proposal
                </h3>
...
<script>
    ...
    document.getElementById('searchInput').addEventListener('keyup', function() {
        ...
        let rows = document.querySelectorAll('#skProposalTableBody tr');
